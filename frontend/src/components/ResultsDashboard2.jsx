    ...
    <div className="w-full max-w-4xl mx-auto bg-gradient-to-br from-white to-gray-50 p-8 rounded-lg shadow-lg">
      ...
      <div className="grid grid-cols-5 gap-4 mb-8">
        {[
          ...
          <div key={index} className="text-center p-4 bg-white rounded-lg border shadow-sm">
      ...
      <div className="py-4 transition-opacity duration-300 ease-in-out">
        {activeTab === 'summary' && (
          <div>
            ...
            <div className="bg-gray-100 p-4 rounded-lg">
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-700">
                {key_findings && key_findings.map((finding, index) => (
        ...
        {activeTab === 'source' && (
          <div>
            ...
            {reverse_image_results && reverse_image_results.matched_sources ? (
              <div>
